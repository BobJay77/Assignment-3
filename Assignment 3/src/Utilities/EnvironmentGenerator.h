...
public:
	...
	static void AddObjectToGeneration(std::string fileName, ShaderMaterial::sptr objMat, int numToSpawn, 
										glm::vec3 spawnFrom, glm::vec3 spawnTo, std::vector<glm::vec3> avoidFrom, 
											std::vector<glm::vec3> avoidTo);
...
private:
	...
	static std::vector<glm::vec3> _spawnFromAll;
	static std::vector<glm::vec3> _spawnToAll;
	static std::vector<std::vector<glm::vec3>> _avoidFromAll;
	static std::vector<std::vector<glm::vec3>> _avoidToAll;
